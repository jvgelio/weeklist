...
**Architecture:** Add a new 'settings' view state, update the sidebar to navigate to it, and create a rich `SettingsView` component that uses the existing preference hooks.

**Tech Stack:** React, Lucide React (icons), existing custom hooks (`useUpdateDisplayPrefs`, `useUpdateSlotPrefs`).

---

### Task 1: Update Types and App State

**Files:**
- Modify: `src/lib/types.ts`
- Modify: `src/components/app.tsx`

- [ ] **Step 1: Add 'settings' to View type**
...
- [ ] **Step 2: Update App.tsx to handle the new view and remove modal state**

```typescript
// src/components/app.tsx
// Remove [showSettings, setShowSettings] = useState(false)
// In the return:
// Replace {view === 'tags' && <TagsView />} with:
// {view === 'tags' && <TagsView />}
// {view === 'settings' && (
//   <SettingsView 
...
//   />
// )}
// Remove <SettingsModal ... /> at the end
```

- [ ] **Step 3: Commit**

```bash
git add src/lib/types.ts src/components/app.tsx
git commit -m "feat(settings): add settings view state and integration"
```
...
- [ ] **Step 1: Update Settings button to be a navigation link**

```typescript
// src/components/sidebar.tsx
// Update the Settings button in the footer:
<ViewButton
...
git commit -m "feat(sidebar): navigate to settings view"
```

### Task 3: Create SettingsView Component

**Files:**
- Create: `src/components/settings-view.tsx`

- [ ] **Step 1: Implement the rich SettingsView component**
...
git commit -m "feat(settings): implement rich SettingsView component"
```

### Task 4: Cleanup Old Modal

**Files:**
- Delete: `src/components/settings-modal.tsx`

- [ ] **Step 1: Delete the unused modal file**

Run: `rm src/components/settings-modal.tsx`

- [ ] **Step 2: Commit**

```bash
git add src/components/settings-modal.tsx
git commit -m "refactor(settings): remove legacy settings modal"
```
